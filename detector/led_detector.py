...
class LedEndpointDetector:
    ...
    def detect_led_body(self, img):
        ...
        # 컨투어 찾기
        contours, _ = self.safe_find_contours(body_mask, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
    ...
    def extract(self, img, box, holes=None):
        ...
        # 4) LED 몸체 및 선 검출
        hull, centroid, body_mask = self.detect_led_body(roi)
